...
$(function () {
    $("span.typedin").typed({
        strings: ["A Son", "A Brother", "A Friend", "A Student", "A Teacher", "A Mechanical Engineer", "A Mathematics Enthusiast", "A Researcher", "The Google Kid", "An IT Executive", "A Business Analyst", "Mr Forrest Gump", "... ."],
